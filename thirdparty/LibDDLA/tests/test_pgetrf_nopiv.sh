#!/bin/bash
#SBATCH -p v100g32fat
#SBATCH -J test_pgetrf_nopiv
##SBATCH -A xgren
#SBATCH --nodes=1
#SBATCH --gres=gpu:4
#SBATCH --ntasks=4
#SBATCH --cpus-per-task=3
#SBATCH --output=../../log_pgetrf_nopiv
#SBATCH --error=../../err_pgetrf_nopiv
...
echo 任务运行节点列表: 
echo Job id : 
echo Begin Time: Fri Jun 19 14:33:36 CST 2026
echo LD_LIBRARY_PATH: 

echo Running test_pgetrf_nopiv with np=4

export OMPI_MCA_btl_openib_allow_ib=1
mpirun -n 4 --mca btl_tcp_if_include ib0,ib1 ./build/tests/test_pgetrf_nopiv

echo End Time: Fri Jun 19 14:33:36 CST 2026
