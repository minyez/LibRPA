...
source=$LIBRPA_ROOT/utilities/convert_legacy_Cs_v1.cpp
g++ -std=c++17 -O2 -o convert_legacy_Cs_v1.exe $source
./convert_legacy_Cs_v1.exe Cs_data_0.txt v1_Cs_data_0.txt
