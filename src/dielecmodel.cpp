...
Array_Desc diele_func::construct_L(const int ifreq, Array_Desc &desc_body)
{
...
std::complex<double> diele_func::compute_chi0_inv_00(const int ifreq, Array_Desc &desc_L)
{
    std::complex<double> total = 0.0;
    Array_Desc desc_q(blacs_ctxt_global_h);
...
std::complex<double> diele_func::compute_chi0_inv_ij(const int ifreq, int i, int j,
                                                     Array_Desc &desc_body, Array_Desc &desc_L)
{
    Array_Desc desc_wing(blacs_ctxt_global_h);
    desc_wing.init_square_blk(n_nonsingular - 1, 3, 0, 0);
    Array_Desc desc_i(blacs_ctxt_global_h);
    desc_i.init_square_blk(1, n_nonsingular - 1, 0, 0);
    auto body_inv_i = init_local_mat<complex<double>>(desc_i, MAJOR::COL);
    Array_Desc desc_j(blacs_ctxt_global_h);
    ...
    Array_Desc desc_lam1(blacs_ctxt_global_h);
