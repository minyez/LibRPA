...
class Chi0
{
   private:
    ...
    void build_chi0_q_space_time_atom_pair_routing(const Cs_LRI &Cs,
                                                   ...
                                                   const vector<atpair_t> &atpairs_ABF,
                                                   const vector<Vector3_Order<double>> &qlist);
    void build_chi0_q_space_time_R_tau_routing(const Cs_LRI &Cs, const Vector3_Order<int> &R_period,
                                               const vector<atpair_t> &atpairs_ABF,
                                               const vector<Vector3_Order<double>> &qlist);
    ...
    void build_chi0_q_conventional(const Cs_LRI &Cs, const Vector3_Order<int> &R_period,
                                   const vector<atpair_t> &atpairs_ABF,
                                   const vector<Vector3_Order<double>> &qlist);
    /*!
   ...
   public:
    ...
    Chi0(const MeanField &mf_in, const vector<Vector3_Order<double>> &klist_in,
