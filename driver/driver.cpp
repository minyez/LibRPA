    ...
    const std::vector<std::pair<std::string, std::string>> str_params
        {
            ...
            normal_pair(input_symmetry_convention),
    ...
    const std::vector<std::pair<std::string, bool>> bool_params
        {
            ...
            bool_pair(use_input_exx_symmetry),
            bool_pair(use_input_gw_symmetry),
            bool_pair(use_input_rpa_symmetry),
